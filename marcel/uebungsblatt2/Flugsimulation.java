...
public class Flugsimulation {
	public static void main(String[] args) {
		...
		System.out.println("Überbuchungen: " + numOfUeberbuchungen + ", bei " + numOfSimulations + " Simulationen; (" + percentageOfUeberbuchungen + "%)");
		System.out.println("Mittelwert: " + mittelWertBuchungen);
	}
}
