...
public class Pythagoras {
     ...
     * @param prevY2
     */
    public static void printNextIteration(double prevX1, double prevY1, double prevX2, double prevY2, int currentLevel, int levelToStop) {
        if(currentLevel >= levelToStop) return;
        ...
        printNextIteration(squareUpperLeftX, squareUpperLeftY, triangleTopX, triangleTopY, currentLevel+1, levelToStop);
        printNextIteration(squareUpperRightX, squareUpperRightY, triangleTopX, triangleTopY,  currentLevel+1, levelToStop);
    }
}
